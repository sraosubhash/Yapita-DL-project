...
training_set = train_datagen.flow_from_directory('C:/Users/vishw/Downloads/New Plant Diseases Dataset(Augmented) - ALL/train', # relative path from working directoy
                                                 target_size = (128, 128),
                                                 batch_size = 6, class_mode = 'categorical')
valid_set = test_datagen.flow_from_directory('C:/Users/vishw/Downloads/New Plant Diseases Dataset(Augmented) - ALL/valid', # relative path from working directoy
                                             target_size = (128, 128), 
